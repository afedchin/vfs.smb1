...
if(PKG_CONFIG_FOUND)
  pkg_check_modules(PC_SMB libdsm QUIET)
endif()

find_path(SMB_INCLUDE_DIR bdsm.h
...
find_library(SMB_LIBRARY NAMES libdsm
                         PATHS ${PC_SMB_LIBDIR})
...
if(SMB_FOUND)
  ...
  set(SMB_DEFINITIONS -DHAVE_LIBDSM=1)
endif()
